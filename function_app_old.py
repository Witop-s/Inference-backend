    ...
    try:
        ...
        messages = [
            SystemMessage(content="""
                ...
                The modification must not introduce new grammatical errors (but preserve existing ones).
                The final sentence must match the speaker's way of speaking.
        ...
        current_message = PromptTemplate(
            template="being_written_message to be modified: {being_written_message}",
