...
class JsonOutput(BaseModel):
    ...
    suspect_score: int = Field(..., ge=0, le=100, description="A number from 0 to 100 representing the inspector's assessment of the suspect's guilt, where 0 = innocent, despite the accusations, his story holds... and 100 = guilty as fuck, straight to jailed, cooked.")
